<?php  
	session_start();
	if (empty($_SESSION['uname']) && $_POST['uname']) {
...
<body>
	<nav id="myHeader" style="margin-left: -9px; margin-right: -9px; margin-top: -8px; position: fixed; top: 8px; width: 100%;">
	    <ul class="ls">
	        <li class="ls"><a href="http://localhost/fuckinFromSkratch/Dashboard.php?val=1">Dashboard</a></li>
	...
	<button type="button" id="logout" class="button3"  onclick="window.location.href = 'http://localhost/fuckinFromSkratch/logout.php?val=1'" value="check" style="margin-right: 5%;
		        										   padding: 6px 16px;
		        										   font-size: 14px;
		...
		<div class="profile_container" style="margin-top: 0;">
			...
			<nav>
				<ul class="ls" style="background-color: rgba(0,0,0,0.4);">
			        <li class="ls" style="width: 100%;"><a href="http://localhost/fuckinFromSkratch/Dashboard.php?val=1">Write Post</a></li>
				</ul>
				<ul class="ls" style="background-color: rgba(0,0,0,0.4);">
